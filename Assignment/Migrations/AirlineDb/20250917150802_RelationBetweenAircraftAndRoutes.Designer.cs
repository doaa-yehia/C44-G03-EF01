...
namespace Assignment.Migrations.AirlineDb
{
    ...
    [Migration("20250917150802_RelationBetweenAircraftAndRoutes")]
    partial class RelationBetweenAircraftAndRoutes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignment.Models.AirLineModel.Aircraft_Route", b =>
                {
                    b.HasOne("Assignment.Models.AirLineModel.Aircraft", "Aircraft")
                        .WithMany("ARoutes")
                        .HasForeignKey("AC_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Assignment.Models.AirLineModel.Route", "Route")
                        .WithMany("A_Aircrafts")
